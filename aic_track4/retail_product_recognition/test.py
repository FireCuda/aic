...
if __name__ == '__main__':
    ...
    face1_path = './dataset/Advil Liquid Gel/00001_1.jpg'
    face2_path = './dataset/Advil Tablets/00002_2.jpg'
    ...
    net.load_state_dict(torch.load('./saved_models/040.pth'))
    ...
    with torch.no_grad():
        ...
        cosine = feature_comparason(normalized_features1, normalized_features2)
